...
from app.models.intelligence import Entity, EntityType, IntelligenceOrigin, normalize_handle
...
def build_identity_hypotheses(
    ...
    *,
    ...
    for ent in entities:
        if ent.type not in (EntityType.HANDLE, EntityType.SOCIAL_ACCOUNT, EntityType.EMAIL):
            continue
